...
// This file contains the header specific to admin dashboards.
...
<body>
    <header class="main-header">
        <div class="container">
            <a href="<?= BASE_URL ?>public/admin/admin_dashboard.php" class="logo">EventCraftAI Admin</a>
            <nav class="main-nav">
                <a href="<?= BASE_URL ?>public/admin/admin_dashboard.php">Dashboard</a>
                <a href="<?= BASE_URL ?>public/admin/users.php">Users</a>
